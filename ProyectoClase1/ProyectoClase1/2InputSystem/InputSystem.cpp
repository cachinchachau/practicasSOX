...
#include "C:\practicasSOX\ProyectoClase1\ProyectoClase1\Utils\ConsoleControl\ConsoleControl.h"
...
{
	//hacer lock por si se añaden cosas mientras estamos haciendo el for
	_classMutex.lock();
